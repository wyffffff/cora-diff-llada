...
BASE_OUT="output/ablations/all_tasks_dapd_paper_limit50"
...
summarize_one () {
  ...
  grep -E "Number of tokens|Generation time|Tokens per second|DAPD avg total steps|DAPD step ratio vs configured steps|DAPD avg tokens per step|flexible-extract|strict-match|exact_match|pass_at_1|non_greedy_accuracy" "$LOG_FILE" || true
  echo "========== END SUMMARY =========="
}
...
run_eval () {
  ...
  NAME="dapd_${ALG_TAG}_${TAU_TAG}_limit50"
...
run_dapd "gsm8k_g256_s256_limit50" "gsm8k" "default" 256 256 \
  "0.01" "0.05" "0.005" "0.05" \
  "${BASE_OUT}/gsm8k_g256_s256_limit50"

run_dapd "gsm8k_g1024_s1024_limit50" "gsm8k" "default" 1024 1024 \
  "0.01" "0.05" "0.005" "0.05" \
  "${BASE_OUT}/gsm8k_g1024_s1024_limit50"

run_dapd "humaneval_g256_s256_limit50" "humaneval" "default" 256 256 \
  "0.01" "0.15" "0.01" "0.05" \
  "${BASE_OUT}/humaneval_g256_s256_limit50"

run_dapd "humaneval_g1024_s1024_limit50" "humaneval" "default" 1024 1024 \
  "0.01" "0.15" "0.01" "0.05" \
  "${BASE_OUT}/humaneval_g1024_s1024_limit50"

run_dapd "mbpp_g256_s256_limit50" "mbpp" "default" 256 256 \
  "0.01" "0.15" "0.01" "0.02" \
  "${BASE_OUT}/mbpp_g256_s256_limit50"

run_dapd "mbpp_g1024_s1024_limit50" "mbpp" "default" 1024 1024 \
  "0.01" "0.15" "0.01" "0.02" \
  "${BASE_OUT}/mbpp_g1024_s1024_limit50"

run_dapd "math_g256_s256_4shot_limit50" "score_non_greedy_robustness_math" "4" 256 256 \
  "0.01" "0.05" "0.005" "0.05" \
  "${BASE_OUT}/math_g256_s256_4shot_limit50"

run_dapd "math_g1024_s1024_4shot_limit50" "score_non_greedy_robustness_math" "4" 1024 1024 \
  "0.01" "0.05" "0.005" "0.05" \
  "${BASE_OUT}/math_g1024_s1024_4shot_limit50"

echo ""
echo "========== FINAL SUMMARY: all DAPD paper limit50 =========="
grep -R -E "Number of tokens|Generation time|Tokens per second|DAPD avg total steps|DAPD step ratio vs configured steps|DAPD avg tokens per step|flexible-extract|strict-match|exact_match|pass_at_1|non_greedy_accuracy" "${BASE_OUT}"/*/*.log || true
