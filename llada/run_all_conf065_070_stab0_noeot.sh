...
BASE_OUT="output/ablations/all_tasks_conf065_070_stab0_noeot"
mkdir -p "$BASE_OUT"
...
run_eval () {
  ...
  CONF_TAG="${CONF/./}"
  NAME="cora_conf${CONF_TAG}_stab0_noeot"
...
# GSM8K 256 已经在这个目录跑过，会自动 skip
run_pair "gsm8k_g256_s256_full" "gsm8k" "default" 256 256 \
  "output/pareto/gsm8k_g256_s256_full_noeot_stab012"

run_pair "gsm8k_g1024_s1024_full" "gsm8k" "default" 1024 1024 \
  "${BASE_OUT}/gsm8k_g1024_s1024_full"

run_pair "humaneval_g256_s256_full" "humaneval" "default" 256 256 \
  "${BASE_OUT}/humaneval_g256_s256_full"

run_pair "humaneval_g1024_s1024_full" "humaneval" "default" 1024 1024 \
  "${BASE_OUT}/humaneval_g1024_s1024_full"

run_pair "mbpp_g256_s256_full" "mbpp" "default" 256 256 \
  "${BASE_OUT}/mbpp_g256_s256_full"

run_pair "mbpp_g1024_s1024_full" "mbpp" "default" 1024 1024 \
  "${BASE_OUT}/mbpp_g1024_s1024_full"

run_pair "math_g256_s256_4shot_full" "score_non_greedy_robustness_math" "4" 256 256 \
  "${BASE_OUT}/math_g256_s256_4shot_full"

echo ""
echo "========== FINAL SUMMARY: all conf065/conf070 stab0 no-EOT =========="
find output/pareto/gsm8k_g256_s256_full_noeot_stab012 "$BASE_OUT" -name "cora_conf0*_stab0_noeot.log" -print0 \
  | xargs -0 grep -E "Number of tokens|Generation time|Tokens per second|CORA actual denoising step ratio|CORA fast accept tokens|flexible-extract|strict-match|exact_match|pass_at_1|non_greedy_accuracy" || true
