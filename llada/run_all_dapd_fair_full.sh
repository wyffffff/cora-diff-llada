...
BASE_OUT="output/ablations/all_tasks_dapd_fair_block32_full"
...
make_dapd_args () {
  ...
  echo "model_path=GSAI-ML/LLaDA-8B-Instruct,gen_length=${GEN},steps=${STEPS},block_length=32,remasking=low_confidence,cfg=0.0,method=DAPD,dapd_alg=${ALG},dapd_layer_ratio=0.3,dapd_tau_min=${TAU_MIN},dapd_tau_max=${TAU_MAX}"
}
...
echo ""
echo "========== FINAL SUMMARY: all DAPD fair block32 full =========="
